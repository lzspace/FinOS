...
| Event schema | 1.0.0 |
| Contract package | 1.1.0 |
| Import profile | only `GenericFinanceCsvV1` |
| Migration entry | product 0.2.0 through 0.9.0 |
...
- no import profile other than `GenericFinanceCsvV1`;
...
Windows and mobile platforms are not part of the 1.0.0 support statement. The
...
- `1.0.x`: bug fixes, security updates and internal optimizations without
